...
const PRIMARY_NAV: NavItem[] = [
  ...
  { href: "/letters",           label:    "Letters",        icon: "letters",     adminOnly: true  },
...
function NavIcon({ name, small }: { name: string; small?: boolean }) {
  ...
  const paths: Record<string, string> = {
    ...
    letters:     "M4 6.5A2.5 2.5 0 016.5 4h11A2.5 2.5 0 0120 6.5v11a2.5 2.5 0 01-2.5 2.5h-11A2.5 2.5 0 014 17.5v-11zm1.5.5l6.5 5 6.5-5M6 17h12",
