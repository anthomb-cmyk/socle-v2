...
const dict = {
  fr: {
    ...
    review: {
      ...
      openClawAnalysis:   "Analyse du juge IA",
      ...
      sectionOpenClaw:     "Analyse du juge IA",
      noOpenClawNote:      "Pas d'analyse du juge IA disponible pour ce candidat.",
  ...
  en: {
    ...
    review: {
      ...
      openClawAnalysis:   "AI judge analysis",
      ...
      sectionSource:       "Source",
      sectionOpenClaw:     "AI judge analysis",
      noOpenClawNote:      "No AI judge analysis available for this candidate.",
